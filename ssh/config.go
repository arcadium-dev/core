...
func NewConfig(prefix ...string) (Config, error) {
	cfg := struct {
		...
		HttpServerAddr string `required:"true" split_words:"true"`
	...
	c := Config{
		...
		httpServerAddr: strings.TrimSpace(cfg.HttpServerAddr),
...
// HTTPServerAddr returns the network address the http portion of the server will listen on.
